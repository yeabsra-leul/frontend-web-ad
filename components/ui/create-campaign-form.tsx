        ...
        <div className="w-full max-w-[60%] space-y-6">
          ...
          <div className="md:flex md:items-center mb-6">
            ...
            <div className="md:flex md:items-center mb-6">
              ...
              <div className="md:w-3/4">
                <textarea id="campaignDescription" name="description" aria-describedby="description-error" placeholder="Enter the description" className="min-h-[150px] appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-blue-500" />
              </div>
            </div>
            <div className="md:flex md:items-center mb-6">
              <div className="md:w-1/4"> </div>
            ...
            <div className="md:flex md:items-center mb-6">
              <div className="md:w-1/4">
                <label className="block text-gray-500 font-bold mb-1 md:mb-0 pr-4" htmlFor="adList">
                  Include Ads*
                </label>
              </div>
              <div className="md:w-3/4">
